...
//        Subject philosophy = new Subject("Philosophy");
        ...
        Group g1 = createOneGroup(701, new Student[]{s1, s2, s3});
        Group g2 = createOneGroup(704, new Student[]{s4, s5, s6});
        Group g3 = createOneGroup(707, new Student[]{s7, s8, s9});
...
//            }
    ...
    public static Group createOneGroup(int number, Student[] students) {
        //Making student groups to pass them to make groups
        Student[] gr1 = students;
